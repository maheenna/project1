    ...
    return (
        <div className='bg-[#99C8FF]'>
            <div className='md:pt-[8rem]  md:pb-[5rem] pt-[5rem] pb-[2rem] '>
                ...
                {/* 1st div */}
                <div className='mt-[4rem] mb-[2rem] md:mx-[6rem] mx-[2rem] items-center'>
  <div className='grid grid-cols-1 md:grid-cols-2 p-[2rem] md:p-[2rem] gap-[2rem] md:gap-[5rem] bg-white rounded-2xl relative'>
